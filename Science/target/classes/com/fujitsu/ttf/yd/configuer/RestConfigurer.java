...
public class RestConfigurer implements WebMvcConfigurer {
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		...
		registry.addResourceHandler("/construction_machinery/pdf_img/**").addResourceLocations("file:" + Constants.HOSE_PDF_IMG + "/");
		...
		registry.addResourceHandler("/rail_transit/pdf_img/**").addResourceLocations("file:" + Constants.PDF_IMG + "/");
...
//		registry.addResourceHandler("/img/app/**").addResourceLocations("file:" + packageUrl + "/");
		...
		//  商用车
		registry.addResourceHandler("/air_suspension/**").addResourceLocations("file:" + Constants.AIR_SUSPENSION_PATH + "/");
		registry.addResourceHandler("/air_suspension/pdf/**").addResourceLocations("file:" + Constants.AIR_SUSPENSION_PDF_PATH + "/");
		registry.addResourceHandler("/air_suspension/img/**").addResourceLocations("file:" + Constants.AIR_SUSPENSION_IMG_PATH + "/");
		registry.addResourceHandler("/air_suspension/pdf_img/**").addResourceLocations("file:" + Constants.AIR_SUSPENSION_PDF_IMG_PATH + "/");
	}
