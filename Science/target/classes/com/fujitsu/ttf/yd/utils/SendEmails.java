...
//	    prop.setProperty("mail.smtp.socketFactory.fallback", "false");
		...
		ts.connect("smtp.exmail.qq.com", "industry@contitechchinasolutions.com.cn", "getji2-mejmAt-dugkyf");
		// 4、创建邮件
	...
	public static MimeMessage createMixedMail(Session session,long pdfName,String targetAddress,String handbookName) throws Exception {
		...
		// 设置邮件的基本信息
		// 邮件发送人 
		message.setFrom(new InternetAddress("industry@contitechchinasolutions.com.cn"));
		//邮件接收人
		...
		text.setContent("<div>尊敬的客户：</div><br/>"
				+"<div>您好!</div><br/>"
				+ "<div>附件是为您定制的专属产品手册，敬请查收。</div><br/>"
				+ "<div>想了解更多大陆集团的资讯和动态，欢迎前往官方网站  https://continental-industry.com 或扫描下方二维码，关注官方微信公众号。</div><br/>"
				+ "<div><img src='cid:1.png'></div><br/>"
				+ "<div>顺颂商祺,</div><br/>"
				+ "<div>Marketing / 市场部</div>"
				+ "<div><b>Tel / 电话:</b> +86 (021) 6080 2022</div><br/>"
				+ "<div><b>Visitor address / 地址:</b></div>"
				...
				+ "<div>上海市杨浦区昆明路518号北美广场A栋20楼</div>"
				+ "<div><img src='cid:2.png'></div>", "text/html;charset=UTF-8");
		// 图片
		...
		image2.setDataHandler(new DataHandler(new FileDataSource("/root/2.png")));
		image2.setContentID("2.png");
 
		// 附件1
		MimeBodyPart attach = new MimeBodyPart();
		DataHandler dh = new DataHandler(new FileDataSource(Constants.MERGE_PATH+handbookName+".pdf"));
