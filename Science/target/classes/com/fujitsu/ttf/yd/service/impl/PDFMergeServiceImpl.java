...
public class PDFMergeServiceImpl implements PDFService {
	...
	public void PDFMerge(List<String> list, String targetAddress,String handbookName,String token,String compony,String customer) {		
		...
		// 设置合并后的文件
		mergerUtil.setDestinationFileName(Constants.MERGE_PATH+handbookName + ".pdf");
		File file2 = null;
		try {
            ...
            for (String key : resultMap.keySet()) {
            	if (key.equals("title")) {
					...
					if (os.startsWith("win") || os.startsWith("Win")) {
						prefixFont = "C:\\Users\\Administrator\\Desktop" + File.separator;
					} else {
						prefixFont = "/usr/share/fonts/" + File.separator;
					}
					BaseFont bf = BaseFont.createFont(prefixFont + "Alibaba-PuHuiTi-Heavy.otf", BaseFont.IDENTITY_H,
							BaseFont.NOT_EMBEDDED);
					form.setFieldProperty("title", "textfont", bf, null);
					form.setFieldProperty("title", "textcolor", new BaseColor(255, 165, 0), null);
					form.setFieldProperty("title", "textsize", (float) 25, null);
					...
					BaseFont bf = BaseFont.createFont(prefixFont + "Alibaba-PuHuiTi-Regular.otf", BaseFont.IDENTITY_H,
							BaseFont.NOT_EMBEDDED);
					form.setFieldProperty("compony", "textcolor", new BaseColor(255, 255, 255), null);
					form.setFieldProperty("compony", "textsize", (float) 15, null);
...
//					BaseFont bf = BaseFont.createFont("STSong-Light", "UniGB-UCS2-H", BaseFont.EMBEDDED);
					...
					form.setFieldProperty("customer", "textsize", (float) 15, null);
